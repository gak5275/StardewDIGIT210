...
(: ebb: Working with name-associated colors this time! 
:)
...
<svg
    ...
    <g
        ...
        
        {
            ...
            let $nameScaled := $namePerc * 10 (:Final number limits graph size: 5 shows 100%/5=20%, 10 shows 100%/10=10:)
            ...
            return
                <g
                    ...
                    <line
                        ...
                        y2="{$pos * $ySpacer}"
                        stroke='{$name-colors[substring-before(., '-') = $n] ! substring-after(., '-')}'
                        stroke-width='20'/>
