...
patterns = [
    ...
    {"label": "NULL", "pattern": "Rasmodius"},
    {"label": "NULL", "pattern": "Necromancer"},
    {"label": "NULL", "pattern": "Joja Bluu"},
    {"label": "NULL", "pattern": "$a#$b#Sorry"},
    {"label": "NULL", "pattern": "$s\\"},
    {"label": "NULL", "pattern": "$h\\I"},
    {"label": "NULL", "pattern": "Rat#Actually"},
    {"label": "NULL", "pattern": "sigh*$s\\"},
    {"label": "NULL", "pattern": "@.\\Sebby"},
    {"label": "NULL", "pattern": "$s\\Have"},
    {"label": "NULL", "pattern": "mope"},
    {"label": "NULL", "pattern": "$8#$b#We'll"},
    {"label": "NULL", "pattern": "Joja"},
    {"label": "NULL", "pattern": "$8\\"},
    {"label": "NULL", "pattern": "Charlie"},
    {"label": "NULL", "pattern": "Planet Yazzo"},
    {"label": "NULL", "pattern": "Yazzo"},
    {"label": "NULL", "pattern": "Yutkin"},
    {"label": "NULL", "pattern": "Lu"},
    {"label": "NULL", "pattern": "Jenu"},
    {"label": "NULL", "pattern": "Gozman"},
    {"label": "NULL", "pattern": "Clara"},
    {"label": "NULL", "pattern": "Horatio"},
    {"label": "NULL", "pattern": "pool4#I"},
    {"label": "NULL", "pattern": "@?$9#$r"},
    {"label": "NULL", "pattern": "box2#You"},
    {"label": "NULL", "pattern": "\\Um"},
    {"label": "NULL", "pattern": "$8\\Well"},
    {"label": "NULL", "pattern": "$h#$b#My"},
    {"label": "NULL", "pattern": "\\Aye"},
    {"label": "NULL", "pattern": "Pappy"},
    {"label": "NULL", "pattern": "Hehehe"},
    {"label": "NULL", "pattern": "Zuzu"},
    {"label": "NULL", "pattern": "$l\\Um"},
    {"label": "NULL", "pattern": "#$b#I'll"},
    {"label": "NULL", "pattern": "#$b#I"},
    {"label": "NULL", "pattern": "@!^Oh"},
    {"label": "NULL", "pattern": "apologize2#You"},
    {"label": "NULL", "pattern": "$7\\Ah"},
    {"label": "NULL", "pattern": "\\Hi Honey.#$b#Tomorrow night"},
    {"label": "NULL", "pattern": "Whew"},
    {"label": "NULL", "pattern": "\\Hey"},
    {"label": "NULL", "pattern": "@.$s\\An"},
    {"label": "NULL", "pattern": "$10\\Well"},
    {"label": "NULL", "pattern": "Kel"},
    {"label": "NULL", "pattern": "K"},
    {"label": "NULL", "pattern": "yes#Sure.#$r"},
    {"label": "NULL", "pattern": "^You"},
    {"label": "NULL", "pattern": "Farmer"},
    {"label": "NULL", "pattern": "kids1#I"},
    {"label": "NULL", "pattern": "kids2#Absolutely"},
    {"label": "NULL", "pattern": "kids3#I"},
    {"label": "NULL", "pattern": "kids4#No"},
    {"label": "NULL", "pattern": "kids5#No"},
    {"label": "NULL", "pattern": "Gunther"},
    {"label": "NULL", "pattern": "$s^You"},
    {"label": "NULL", "pattern": "#$b#I'd"},
    {"label": "NULL", "pattern": "phi-lo"},
    {"label": "NULL", "pattern": "@?$s#$r 83"},
    {"label": "NULL", "pattern": "parents5#Yeah"},
    {"label": "NULL", "pattern": "Marlon"},
    {"label": "NULL", "pattern": "MarILDA"},
    {"label": "NULL", "pattern": "null#Hey"},
    {"label": "NULL", "pattern": "bush"},
    {"label": "NULL", "pattern": "@.^I've"},
    {"label": "NULL", "pattern": "Yoba"},
    {"label": "NULL", "pattern": "$a#$b#Sorry"},
    {"label": "NULL", "pattern": "bluu"},
